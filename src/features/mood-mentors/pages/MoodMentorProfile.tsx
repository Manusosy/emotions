...
const MoodMentorProfile = () => {
  ...
  // Fetch moodMentor data
  useEffect(() => {
    const fetchMoodMentorData = async () => {
      if (!moodMentorId) return;
      
      console.log(`Fetching moodMentor data for ID: ${moodMentorId}`);
      setLoading(true);
      try {
        const response = await moodMentorService.getMoodMentorProfile(moodMentorId);
        
        if (response.success && response.data) {
          console.log("Successfully fetched moodMentor data:", response.data.name);
          setMoodMentor(response.data);
          if (response.completeness) {
            setProfileCompleteness(response.completeness);
          }
        } else {
          console.error("Failed to load moodMentor profile:", response.error);
          toast.error("Failed to load moodMentor profile");
          // Fallback to mock data
          setMoodMentor({...mockMoodMentor, id: moodMentorId || "1"});
        }
      } catch (error) {
        console.error("Error fetching moodMentor data:", error);
      ...
      <div className="relative z-10">
        ...
        <div className="w-full flex justify-center items-center py-16">
          <div className="text-center max-w-3xl">
            ...
            >
              View detailed information about your mental health moodMentor, their qualifications, experience, and 
        ...
        <div className="container mx-auto px-4 pb-16">
          ...
          >
            <div className="p-6 flex flex-col md:flex-row gap-6">
              {/* moodMentor image and gallery */}
              <div className="flex-shrink-0">
                <div className="mb-3">
                  <img 
                    src={moodMentor?.image} 
                    alt={moodMentor?.name || "MoodMentor"}
              ...
              <div className="flex-1">
                ...
                {/* CTA buttons - moved to the bottom right of the moodMentor info section */}
                <div className="flex flex-col md:flex-row gap-2 justify-start items-start md:items-end mt-4 md:justify-end">
                  ...
                  <BookingButton 
                    mentorId={moodMentor?.id || "2"}
                    className="mt-2 md:mt-0 md:ml-2" 
                    text={moodMentor?.isFree ? "BOOK APPOINTMENT" : "UNAVAILABLE"}
                    variant="default"
        ...
        <Dialog open={showChatDialog} onOpenChange={setShowChatDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Send a message and get a quick response from your mental health moodMentor.
              </DialogDescription>
            </DialogHeader>
        ...
        <Dialog open={showChatAuthDialog} onOpenChange={setShowChatAuthDialog}>
          <DialogContent className="sm:max-w-md">
            ...
            <div className="mt-4 text-center">
              <p className="mb-4">Please log in to start a conversation with this moodMentor.</p>
              <div className="flex justify-center gap-4">
